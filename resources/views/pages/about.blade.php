<x-layouts.app title="a propos">
    <div class="w-full h-full place-content-center text-center">
        <h1 class="border rounded-full m-2 p-2 bg-base-green text-base-gray">Notre histoire</h1>
    ...
    <div class="w-full h-full place-content-center text-center">
        <h1 class="border rounded-full m-2 p-2 bg-base-green text-base-gray">Nos valeurs</h1>
        <div class="flex flex-wrap gap-2 justify-center font-bold">
            <p class="border rounded-2xl bg-base-green text-base-gray p-2">Proximité & Lien humain</p>
            <p class="border rounded-2xl bg-base-green text-base-gray p-2">Terroir & Authenticité</p>
            <p class="border rounded-2xl bg-base-green text-base-gray p-2">Confiance</p>
            <p class="border rounded-2xl bg-base-green text-base-gray p-2">Savoir-faire</p>
            <p class="border rounded-2xl bg-base-green text-base-gray p-2">Solidarité</p>
        </div>
    </div>
</x-layouts.app>