<x-layouts.app title="Inscription">
    <div class="min-h-screen bg-[#dcdcdc] flex flex-col justify-center items-center p-4 font-sans">
        <form id="registerForm" enctype="multipart/form-data" 
            class="bg-[#057941] w-full max-w-[600px] rounded-2xl sm:rounded-[32px] shadow-[0_0_15px_rgba(93,176,229,0.4)] p-6 sm:p-10 flex flex-col items-center relative">
            @csrf
            ...
            <div class="w-full flex flex-col gap-8">
                ...
                <a href="{{ url('/auth/google/redirect') }}" class="px-6 sm:px-10 py-3 sm:py-4 text-white bg-transparent border-2 border-white rounded-full hover:bg-white/20 transition-all duration-200 text-xs sm:text-sm font-medium tracking-wide focus:outline-none cursor-pointer flex items-center gap-3 justify-center w-full sm:w-[85%] sm:max-w-[320px] mx-auto">
