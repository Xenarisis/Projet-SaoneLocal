...
<div class="w-full flex items-center px-6 py-2.5 sm:py-3 border-2 border-white rounded-full bg-transparent hover:bg-white/20 focus-within:bg-white/20 cursor-text focus-within:ring-2 focus-within:ring-white focus-within:ring-offset-2 focus-within:ring-offset-[#00833F] transition-all duration-200">
